  ...
  if (isError) {
    return (
      <p className="p-8 text-red-600">
        Gagal memuat data paket. Pastikan backend sedang berjalan.
      </p>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto p-8">
      ...
      <p className="text-gray-500 mb-8">
        Pilih paket perencana pernikahan yang sesuai kebutuhanmu.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {packages?.map((pkg) => {
          ...
          const waMessage = encodeURIComponent(
            `Halo, saya tertarik dengan ${pkg.nama_paket} seharga Rp ${pkg.harga.toLocaleString("id-ID")}.`,
          );
          ...
          return (
            ...
            >
              ...
              {pkg.nama_paket === "Paket Vendor Tracker" && (
                <Link
                  to="/wedding-planner/trial-vendor-tracker"
                  className="mt-6 border border-rose-700 text-rose-700 text-center py-2 rounded-md hover:bg-rose-50 transition-colors"
                >
                  Coba Trial Gratis
                </Link>
              ...
              <a
                ...
                className="mt-6 bg-rose-700 text-white text-center py-2 rounded-md hover:bg-rose-800 transition-colors"
              >
                Pesan Sekarang
              </a>
            </div>
