// frontend/src/pages/demo/KoranLama/components/MusicPlayer.tsx
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 right-4 sm:top-5 sm:right-5 z-50 w-11 h-11 rounded-none border-2 bg-[#f4ecd8] border-[#2b2620] backdrop-blur-md flex items-center justify-center shadow-lg hover:scale-105 active:scale-95 transition-transform"
      >
        <svg
          viewBox="0 0 24 24"
          className={`w-5 h-5 text-[#2b2620] ${playing ? "animate-[spin_4s_linear_infinite]" : ""}`}
          fill="none"
        >
