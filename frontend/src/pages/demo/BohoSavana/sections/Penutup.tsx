// frontend/src/pages/demo/BohoSavana/sections/Penutup.tsx
...
function Penutup() {
  return (
    <motion.div
      ...
      transition={{ duration: 0.7, ease: "easeOut" }} className="min-h-screen bg-gradient-to-b from-[#b5654a] to-[#6b4230] text-white flex flex-col items-center justify-center px-6 py-20 pb-28 text-center">
