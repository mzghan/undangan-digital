// frontend/src/pages/demo/SenjaAesthetic/sections/Penutup.tsx
...
function Penutup() {
  return (
    <motion.div
      ...
      transition={{ duration: 0.7, ease: "easeOut" }} className="min-h-screen bg-gradient-to-b from-[#c17b5f] to-[#8a5a45] text-white flex flex-col items-center justify-center px-6 py-20 pb-28 text-center">
      ...
      <div className="mt-16 pt-6 border-t border-white/20 text-[10px] tracking-widest uppercase text-white/60">
        Undangan Digital — Senja Aesthetic
      </div>
    </motion.div>
  );
}
