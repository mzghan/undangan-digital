// frontend/src/pages/demo/SenjaAesthetic/sections/RSVP.tsx
...
function RSVP() {
  ...
  if (terkirim) {
    return (
      ...
      >
        <div className="bg-white rounded-2xl shadow-md shadow-[#c17b5f]/10 px-8 py-10 max-w-sm">
          <p className="font-heading text-2xl mb-3">Terima kasih, {nama}!</p>
          <p className="text-sm text-[#8c7b6f]">
  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="w-full max-w-md bg-white rounded-2xl shadow-md shadow-[#c17b5f]/10 px-6 py-8 flex flex-col gap-5"
      >
        <div>
          <label className="text-sm text-[#8c7b6f] block mb-1">Nama</label>
          <input
            type="text"
            value={nama}
            onChange={(e) => setNama(e.target.value)}
            placeholder="Nama lengkap"
            className="w-full bg-[#faf5f0] border border-transparent rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-[#c17b5f]"
          />
        </div>

        <div>
          <label className="text-sm text-[#8c7b6f] block mb-2">
            Status Kehadiran
          </label>
            ...
            <button
              ...
              className={`flex-1 rounded-xl px-4 py-2.5 text-sm transition-colors ${
                status === "hadir"
                  ...
                  : "bg-[#faf5f0] text-[#8c7b6f] hover:bg-[#f0dcd2]"
              }`}
            >
              Hadir
            </button>
        ...
        {status === "hadir" && (
          <div>
            <label className="text-sm text-[#8c7b6f] block mb-1">
              Jumlah Tamu
            </label>
            <input
              type="number"
        ...
        <button
          type="submit"
          className="bg-[#c17b5f] text-white rounded-full px-8 py-3.5 text-sm font-medium tracking-wide shadow-lg shadow-[#c17b5f]/30 hover:bg-[#a05a45] transition-colors mt-2"
        >
          Kirim Konfirmasi
        </button>
      </form>
