...
function RSVP() {
  ...
  if (terkirim) {
    return (
      ...
      >
        <div className="bg-white rounded-3xl shadow-md shadow-[#c17b5f]/10 px-8 py-10 max-w-sm">
  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="w-full max-w-md bg-white rounded-3xl shadow-md shadow-[#c17b5f]/10 px-6 py-8 flex flex-col gap-5"
      >
        <div>
