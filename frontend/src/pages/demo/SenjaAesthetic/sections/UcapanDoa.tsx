// frontend/src/pages/demo/SenjaAesthetic/sections/UcapanDoa.tsx
  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="w-full max-w-md bg-white rounded-2xl shadow-md shadow-[#c17b5f]/10 px-6 py-6 flex flex-col gap-4 mb-10"
      >
        <input
          type="text"
          value={nama}
          ...
          className="w-full bg-[#faf5f0] rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-[#c17b5f]"
        />
        <textarea
          value={pesan}
          ...
          rows={3}
          className="w-full bg-[#faf5f0] rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-[#c17b5f] resize-none"
        />
        <button
          type="submit"
          className="self-start bg-[#c17b5f] text-white rounded-full px-6 py-2.5 text-sm hover:bg-[#a05a45] transition-colors"
        >
          Kirim Ucapan
        </button>
      </form>
      ...
      <div className="w-full max-w-md flex flex-col gap-3 max-h-[400px] overflow-y-auto">
        {daftarUcapan.map((u) => (
          <div
            key={u.id}
            className="bg-white rounded-2xl shadow-sm shadow-[#c17b5f]/10 px-5 py-4"
          >
            <p className="font-heading text-sm text-[#c17b5f] mb-1">
              {u.nama}
            </p>
