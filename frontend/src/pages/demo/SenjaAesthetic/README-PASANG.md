# Cara Pasang Tema SenjaAesthetic

1. Extract folder `SenjaAesthetic` ini ke: `frontend/src/pages/demo/SenjaAesthetic`
...
4. Jalankan `npm run dev`, lalu buka:
   http://localhost:5173/undangan-digital/demo/senja-aesthetic
