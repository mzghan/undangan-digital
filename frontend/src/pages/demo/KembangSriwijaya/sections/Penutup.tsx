...
function Penutup() {
  return (
    <motion.div
      ...
      transition={{ duration: 0.7, ease: "easeOut" }} className="min-h-screen bg-gradient-to-b from-[#2b1b12] via-[#3d2817] to-[#2b1b12] text-[#f5e9d6] flex flex-col items-center justify-center px-6 py-20 text-center">
