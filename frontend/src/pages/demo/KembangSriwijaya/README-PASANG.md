# Cara Pasang Tema KembangSriwijaya

1. Extract folder `KembangSriwijaya` ini ke: `frontend/src/pages/demo/KembangSriwijaya`
...
4. Jalankan `npm run dev`, lalu buka:
   http://localhost:5173/undangan-digital/demo/kembang-sriwijaya
