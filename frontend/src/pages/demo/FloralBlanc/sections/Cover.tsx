...
function Cover({ onBuka }: { onBuka: () => void }) {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-end overflow-hidden bg-gradient-to-br from-[#e8c9c9] via-[#c9a06e] to-[#9c6b6b]">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 pb-16 sm:pb-20 text-white">
        ...
        <button
          onClick={onBuka}
          className="bg-white text-[#a8794a] rounded-full px-9 py-3.5 text-sm font-medium tracking-wide shadow-lg shadow-black/20 hover:scale-105 active:scale-95 transition-transform"
        >
          Buka Undangan
        </button>
      </div>
