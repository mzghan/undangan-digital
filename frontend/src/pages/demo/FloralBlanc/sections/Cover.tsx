    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#faf6f0] text-[#5c4a45] px-6 py-16">
      ...
      <div className="relative w-full max-w-sm border border-[#c9a06e]/50 p-1">
        <div className="border border-[#c9a06e]/30 px-8 py-12 flex flex-col items-center text-center">
          ...
          <div className="w-28 h-36 lg:w-32 lg:h-40 rounded-[50%] overflow-hidden bg-gradient-to-b from-[#e8c9c9] via-[#c9a06e] to-[#9c6b6b] mb-8 border border-[#c9a06e]/40">
            <img src={foto.cover} alt={`${mempelai.pria.panggilan} & ${mempelai.wanita.panggilan}`} className="w-full h-full object-cover" />
          </div>
