// frontend/src/pages/demo/FloralBlanc/sections/Penutup.tsx
...
function Penutup() {
  return (
    <motion.div
      ...
      transition={{ duration: 0.7, ease: "easeOut" }} className="min-h-screen bg-gradient-to-b from-[#c9a06e] to-[#9c6b6b] text-white flex flex-col items-center justify-center px-6 py-20 pb-28 text-center">
