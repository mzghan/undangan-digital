# Cara Pasang Tema FloralBlanc

1. Extract folder `FloralBlanc` ini ke: `frontend/src/pages/demo/FloralBlanc`
...
4. Jalankan `npm run dev`, lalu buka:
   http://localhost:5173/undangan-digital/demo/floral-blanc
