// frontend/src/pages/demo/PuspaBali/sections/RSVP.tsx
...
function RSVP() {
  ...
  if (terkirim) {
    return (
      ...
      >
        <div className="bg-white rounded-none border border-[#c9a24b]/40 shadow-md shadow-[#c9a24b]/10 px-8 py-10 max-w-sm">
  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="w-full max-w-md bg-white rounded-none border border-[#c9a24b]/40 shadow-md shadow-[#c9a24b]/10 px-6 py-8 flex flex-col gap-5"
      >
        <div>
          <label className="text-sm text-[#8a7f6b] block mb-1">Nama</label>
          <input
            type="text"
            value={nama}
            onChange={(e) => setNama(e.target.value)}
            placeholder="Nama lengkap"
            className="w-full bg-[#fdf8ef] border border-transparent rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-[#c9a24b]"
          />
        </div>

        <div>
          <label className="text-sm text-[#8a7f6b] block mb-2">
            Status Kehadiran
          </label>
            ...
            <button
              ...
              className={`flex-1 rounded-xl px-4 py-2.5 text-sm transition-colors ${
                status === "hadir"
                  ...
                  : "bg-[#fdf8ef] text-[#8a7f6b] hover:bg-[#f0e2b8]"
              }`}
            >
              Hadir
            </button>
        ...
        {status === "hadir" && (
          <div>
            <label className="text-sm text-[#8a7f6b] block mb-1">
              Jumlah Tamu
            </label>
            <input
              type="number"
        ...
        <button
          type="submit"
          className="bg-[#c9a24b] text-white rounded-full px-8 py-3.5 text-sm font-medium tracking-wide shadow-lg shadow-[#c9a24b]/30 hover:bg-[#a17c2f] transition-colors mt-2"
        >
          Kirim Konfirmasi
        </button>
      </form>
