// frontend/src/pages/demo/PastelRetro/sections/UcapanDoa.tsx
    ...
    >
      ...
      >
        <input
          ...
          className="w-full bg-[#fdf6f0] rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-[#d17a9e]"
        />
        <textarea
          value={pesan}
          ...
          rows={3}
          className="w-full bg-[#fdf6f0] rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-[#d17a9e] resize-none"
        />
        <button
          type="submit"
      ...
      <div className="w-full max-w-md flex flex-col gap-3 max-h-[400px] overflow-y-auto">
        {daftarUcapan.map((u) => (
          ...
          >
            ...
            <p className="text-sm text-[#6b5040]">{u.pesan}</p>
          </div>
        ))}
      </div>
    </motion.div>
