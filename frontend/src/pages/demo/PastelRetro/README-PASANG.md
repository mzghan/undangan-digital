# Cara Pasang Tema PastelRetro

1. Extract folder `PastelRetro` ini ke: `frontend/src/pages/demo/PastelRetro`
...
4. Jalankan `npm run dev`, lalu buka:
   http://localhost:5173/undangan-digital/demo/pastel-retro
