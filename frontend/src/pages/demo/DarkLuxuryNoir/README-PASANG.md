# Cara Pasang Tema DarkLuxuryNoir

1. Extract folder `DarkLuxuryNoir` ini ke: `frontend/src/pages/demo/DarkLuxuryNoir`
...
4. Jalankan `npm run dev`, lalu buka:
   http://localhost:5173/undangan-digital/demo/dark-luxury-noir
