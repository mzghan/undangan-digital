...
function Cover({ onBuka }: { onBuka: () => void }) {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-end overflow-hidden bg-gradient-to-br from-[#3a3a3a] via-[#d4af6a] to-[#0a0a0a]">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 pb-16 sm:pb-20 text-white">
        ...
        <button
          onClick={onBuka}
          className="bg-white text-[#b8933f] rounded-full px-9 py-3.5 text-sm font-medium tracking-wide shadow-lg shadow-black/20 hover:scale-105 active:scale-95 transition-transform"
        >
          Buka Undangan
        </button>
      </div>
