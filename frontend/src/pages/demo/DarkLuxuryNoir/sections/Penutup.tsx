...
function Penutup() {
  return (
    <motion.div
      ...
      transition={{ duration: 0.7, ease: "easeOut" }} className="min-h-screen bg-gradient-to-b from-[#d4af6a] to-[#0a0a0a] text-white flex flex-col items-center justify-center px-6 py-20 pb-28 text-center">
