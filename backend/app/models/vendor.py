...
class Vendor(Base):
    ...
    kategori = Column(String, nullable=True)  # venue | catering | dekorasi | dokumentasi | mua | hiburan | lain
    ...
    tanggal_kontrak = Column(DateTime, nullable=True)
    dokumen_kontrak_url = Column(String, nullable=True)  
